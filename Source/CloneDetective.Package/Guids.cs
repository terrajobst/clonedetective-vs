...
namespace CloneDetective.Package
{
	internal static class Guids
	{
		...
		public const string GuidCloneBackgroundMarkerString = "877b4dbe-df33-4764-9e8e-9e19fa772e21";
		public const string GuidCloneMarginMarkerString = "c6d11640-5b3a-45ec-8118-53ee3380ddab";

		public static readonly Guid GuidCommandSet = new Guid(GuidCommandSetString);

		public static readonly Guid GuidCloneBackgroundMarker = new Guid(GuidCloneBackgroundMarkerString);
		public static readonly Guid GuidCloneMarginMarker = new Guid(GuidCloneMarginMarkerString);
